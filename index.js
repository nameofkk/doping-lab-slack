...
(async () => {
  ...
  loadRules();
  loadSettings();
  loadTasks(); loadJobs(); loadFacts(); loadSkills(); loadOntology(); loadSouls(); loadOpps(); loadRoadmap(); loadBlockers(); loadWave4(); buildMcpConfig(); loadDecisions(); loadUsage(); loadBiz(); loadExperiments(); loadPendingDispatch(); loadOpsConfig(); loadCI(); loadCooldowns();
  loadLastRepo();
  loadServices();
  loadPending();
