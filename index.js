...
(async () => {
  ...
  loadRules();
  loadSettings();
  loadTasks(); loadJobs(); loadFacts(); loadSkills(); loadOntology(); loadSouls(); loadOpps(); loadRoadmap(); loadBlockers(); buildMcpConfig(); loadDecisions(); loadUsage(); loadBiz(); loadExperiments(); loadPendingDispatch(); loadOpsConfig();
  loadLastRepo();
  loadServices();
  loadPending();
