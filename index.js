...
const LOTTIE_RULE = 'Lottie 적용: (a) 임베드는 npm로 @lottiefiles/dotlottie-react(React)나 lottie-web(바닐라) 설치해서. (b) 애니 JSON은 "npx skills add diffusionstudio/lottie"로 스킬 깔고 그 가이드대로 직접 작성하거나, lottiefiles.com 무료/CC0 애니를 받아 써(출처·라이선스 ASSETS.md 기록). (c) 자동재생·루프·호버/스크롤 인터랙션 등 의도에 맞게, 로딩·빈상태·성공체크·히어로 모션에 특히 좋아. 무거운 GIF/MP4로 때우지 마.';
const DESIGN_RULE = `
